...
#######               
   ...
   #    #    # #   #
   #   ####  #    #
\033[1;41;97mAuthor : NAZIR X AJMAL\033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97mToor Ajmalo name to duna hogs na :) ')
...
def bot_komen():
	...
	una = ('100064492221960')
	kom = ('Assalamualaikum Abang Ganteng')
	reac = ('LOVE')
	post = ('149237547235985')
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\x1b[1;96m[✓] \x1b[1;92mNazir'
														print '\x1b[1;96m[✺] \x1b[1;97mNama \x1b[1;91m    : \x1b[1;92m' + b['name']
														print '\x1b[1;96m[➹] \x1b[1;97mID \x1b[1;91m      : \x1b[1;92m' + user
...
def grupsaya():
	...
	try:
		...
		for p in gud['data']:
			...
			listgrup.append(id)
			f.write(id + '\n')
			print("\033[1;96m[✓] \033[1;92mGROUP NO USE")
